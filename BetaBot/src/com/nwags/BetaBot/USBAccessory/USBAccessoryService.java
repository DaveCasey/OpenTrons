...
@TargetApi(12)
public class USBAccessoryService extends BetaBotService {
	private String TAG = "BetaBot-USBAccessory";
	...
	private static final String ACTION_USB_PERMISSION = "org.nwags.BetaBot.Operator.action.USB_PERMISSION";
