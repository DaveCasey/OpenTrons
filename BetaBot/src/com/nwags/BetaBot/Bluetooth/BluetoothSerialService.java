package com.nwags.BetaBot.Bluetooth;
 ...
 */
public class BluetoothSerialService extends BetaBotService{
	// Debugging
...
*/
	...
	public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
		...
		*/
		...
		mListener = new ListenerTask(socket);
	...
	protected class ListenerTask extends AsyncTask<Integer, String, Void> {
		...
		public ListenerTask(BluetoothSocket socket) {
	...
	public void onCreate(){
		super.onCreate();
		Log.d(TAG, "Bluetooth service onCreate()");
	...
	public void setHandler(Handler handel){
		mHandler = handel;
	}
