...
Ingredients.prototype.addIngredient = function(ing){
	...
	if(ing) newIngredient.name = ing.name;
	else newIngredient.name = 'untitled_'+this.nameCounter;
	...
	nameText.value = newIngredient.name;
