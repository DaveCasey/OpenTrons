...
Job.prototype.addStep = function(index){
	...
	actionDiv.style.color = app.colors.grey;
	...
	var actionColors = ['blue','red','green','green'];

	for(var i=0;i<actionOptions.length;i++){
		var tempOption = document.createElement('option');
		tempOption.style.color= app.colors[actionColors[i]];
